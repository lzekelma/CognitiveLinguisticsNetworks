...
class SorterClass:
    ...
    def sort_words(self,non_lemmatized_string):
        d = enchant.Dict("en_US")
        if non_lemmatized_string == "":
            return ""
        lower_case_text = non_lemmatized_string.lower()
        non_lemmatized_list = lower_case_text.split("||")
        sorted_list = []
        for each_word in non_lemmatized_list:
    ...
    def main(self):
        ...
        output_file = open("OutputData/One_Minute_Responses_Sorted_Non_Lemmatized.csv","w")
